...
const ShowcaseSection = () => {
  return (
    <div>
      <div
        className="flex flex-col items-center justify-center rounded-md bg-gradient-to-r from-primary-light to-primary-dark p-5"
        data-aos="flip-up"
      ...
      <div
        className="flex flex-col w-full md:w-auto md:flex-row justify-center items-center md:items-stretch mt-6 space-y-4 md:space-y-0 md:space-x-4"
        data-aos="fade-up"
        data-aos-duration="1500"
      >
