  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center">
        <div className="text-4xl md:text-4xl lg:text-5xl font-semibold mb-2 md:mt-20 max-w-screen-md text-center">
          Modernize retail labeling with our ESL revolution
        </div>
        <div className="text-sm md:text-lg font-light max-w-screen-md text-center">
